...
- Sayfa seviyesi bilesenler pages altinda, tekrar kullanilanlar components altinda tutulur.
...
## 8. Test Kurallari
- Backend testleri tests altinda pytest ile, frontend testleri web/src/test altinda tutulur.
